		...
		<div class="wrapper">
			<div class="container">
				...
				<div class="view-messages"> 
					Please do not reply to this message; it was sent from an unmonitored email address. This message is a service email related to your use of BuildYourExam.com.
				 </div>
			</div>
		</div>
	</body>
