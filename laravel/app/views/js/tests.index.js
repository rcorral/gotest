jQuery('table')
	.on('click', '.js-start-session', function()
	{
		core.modal({
			...
			footer: '<button data-dismiss="modal" aria-hidden="true" class="btn btn-default">Close</button> <button data-dismiss="modal" class="btn btn-primary form-submit" data-form-submit="js-session-begin">Start!</button>'
		});
